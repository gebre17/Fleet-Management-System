...
from app.schemas.location import LocationCreate, LocationHistoryResponse, LocationResponse
...
@router.get("/{vehicle_id}/location", response_model=LocationResponse | None)
